...
async def test_draft_proposal_node_forwards_harmonisation_items_with_full_evidence() -> None:
    ...
    proposal_dict = {
        ...
        "series": {"action": "new", "code": "US_CPI_NSA_M", "name": "US CPI NSA Monthly", "frequency": "monthly", "measure": "index_level", "unit_kind": "pure"},
        "source": {"provider_code": "FRED", "external_code": "CPIAUCNS"},
...
async def test_draft_proposal_node_drops_harmonisation_item_missing_cohort_members() -> None:
    ...
    proposal_dict = {
        "concept": {"action": "new", "code": "CPI", "name": "Consumer Price Index"},
        "family": {"action": "new", "code": "US_CPI", "name": "US CPI", "concept_code": "CPI", "geography_code": "USA"},
        "series": {"action": "new", "code": "US_CPI_SA_M", "name": "US CPI SA Monthly", "frequency": "monthly", "measure": "index_level", "unit_kind": "pure"},
    ...
    async def fake_draft_llm(messages: list[dict[str, str]]) -> dict[str, Any]:
        return {
            "proposal": {
                ...
                "series": {"action": "new", "code": "US_GDP_Q", "name": "US GDP Quarterly", "frequency": "quarterly", "measure": "level", "unit_kind": "currency"},
                "source": {"provider_code": "BEA", "external_code": "GDP"},
                "feed": {"selector_type": "json_path", "cron_schedule": "0 14 * * 5"},
                "family_member": {},
            },
            "enum_gap_proposals": [],
