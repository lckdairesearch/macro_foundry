...
def _minimal_proposal() -> DraftProposal:
    return DraftProposal(
        ...
        source=DraftSeriesSource(provider_code="FRED", external_code="CPIAUCSL"),
        feed=DraftIngestionFeed(selector_type="json_path", cron_schedule="0 14 * * 5"),
...
def test_draft_proposal_accepts_hierarchy_edges() -> None:
    proposal = DraftProposal(
        ...
        source=DraftSeriesSource(provider_code="FRED", external_code="CPILFESL"),
        feed=DraftIngestionFeed(selector_type="json_path", cron_schedule="0 14 * * 5"),
...
def test_draft_proposal_existing_action_does_not_require_description() -> None:
    proposal = DraftProposal(
        ...
        source=DraftSeriesSource(provider_code="FRED", external_code="CPIAUCNS"),
        feed=DraftIngestionFeed(selector_type="json_path", cron_schedule="0 14 * * 5"),
